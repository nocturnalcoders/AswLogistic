package com.ASWLogistic.validator;
...
public class MinDatesDifferenceValidator implements ConstraintValidator<MinDatesDifference, Object> {
    private String firstDateName;
    private String secondDateName;
    private long millis;

    public void initialize(MinDatesDifference constraintAnnotation) {
    ...
    public boolean isValid(Object value,
        ...
        try {
            ...
            LocalDateTime firstDate = LocalDateTime.parse(firstObj.toString());
